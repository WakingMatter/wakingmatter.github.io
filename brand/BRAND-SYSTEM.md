...
> **Geometry, finish, and wordmark frozen together.** Source occupancy + modeled two-value finish + outlined Gloock-derived recut at 04-tight 0.38×cap. Do not reopen geometry, finish, color, mono fallback, or type. Identity application, broader site application, and editorial review have passed. Do not merge until GitHub Pages is switched from branch/root to GitHub Actions.
